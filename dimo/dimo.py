...
class DIMO:
    ...
    async def get_vehicle_history(self, privileged_token, token_id):
        ...
        return self.request('GET', 'DeviceData', url, headers=self._get_auth_headers(privileged_token))
    ...
    async def get_user_device_status(self, access_token, user_device_id):
        ...
        return self.request('GET', 'DeviceData', url, headers=self._get_auth_headers(access_token))
    ...
    async def get_user_device_history(self, access_token, user_device_id, start_date=None, end_date=None):
        ...
        return self.request('GET', 'DeviceData', url, headers=self._get_auth_headers(access_token), params=params)
    ...
    async def send_json_export_email(self, access_token, user_device_id):
        ...
        return self.request('POST', 'DeviceData', url, headers=self._get_auth_headers(access_token))
    ...
    async def create_vehicle(self, access_token, country_code, device_definition_id):
        ...
        return self.request('POST','Devices', '/v1/user/devices', headers=self._get_auth_headers(access_token), params=params)
    ...
    async def create_vehicle_from_smartcar(self, access_token, code, country_code, redirect_uri):
        ...
        return self.request('POST', 'Devices', '/v1/user/devices/fromsmartcar', headers=self._get_auth_headers(access_token), params=params)
    ...
    async def create_vehicle_from_vin(self, access_token, can_protocol, country_code, vin):
        ...
        return self.request('POST', 'Devices', '/v1/user/devices/fromvin', headers=self._get_auth_headers(access_token), params=params)
    ...
    async def update_vehicle_vin(self, access_token, user_device_id):
        ...
        return self.request('PATCH', 'Devices', url, headers=self._get_auth_headers(access_token))
    ...
    async def get_claiming_payload(self, access_token, serial):
        ...
        return self.request('POST', 'Devices', url, headers=self._get_auth_headers(access_token))
    ...
    async def sign_claiming_payload(self, access_token, serial, claim_request):
        ...
        url = f'/v1/aftermarket/device/by-serial/{serial}/commands/claim'
        return self.request('POST', 'Devices', url, headers=self._get_auth_headers(access_token), params=params)
    ...
    async def get_pairing_payload(self, access_token, user_device_id):
        ...
        return self.request('GET', 'Devices', url, headers=self._get_auth_headers(access_token))
    ...
    async def lock_doors(self, privilege_token, token_id):
        ...
        return self.request('POST', 'Devices', url, headers=self._get_auth_headers(privilege_token))
    ...
    async def get_events(self, access_token):
        ...
        return self.request('GET', 'Events', '/v1/events', headers=self._get_auth_headers(access_token))
    ...
    async def token_exchange(self, access_token, privileges, token_id, env="Production"):
        ...
        response = self.request('POST', 'TokenExchange', '/v1/tokens/exchange', headers=self._get_auth_headers(access_token), data=body)
        return response

    ######################## TRIPS ########################
    async def trips(self, privilege_token, token_id):
        url = f'/v1/vehicle/{token_id}/trips'
        return self.request('GET', 'Trips', url, headers=self._get_auth_headers(privilege_token))

    ######################## USER ########################
    async def user(self, access_token):
        return self.request('GET', 'User', '/v1/user', headers=self._get_auth_headers(access_token))

    async def update_user(self, access_token):
        return self.request('PUT', 'User', '/v1/user', headers=self._get_auth_headers(access_token))

    async def delete_user(self, access_token):
        return self.request('DELETE', 'User', '/v1/user', headers=self._get_auth_headers(access_token))

    # send_confirmation_email - /v1/user/send-confirmation-email [POST]
    async def send_confirmation_email(self, access_token):
        return self.request('POST', 'User', '/v1/user/send-confirmation-email', headers=self._get_auth_headers(access_token))
    ...
    async def confirm_email(self, access_token, confirm_email_request):
        ...
        return self.request('POST', 'User', 'v1/user/confirm-email', headers=self._get_auth_headers(access_token))
    ...
    async def get_valuations(self, access_token, user_device_id):
        ...
        return self.request('GET', 'Valuations', url, headers=self._get_auth_headers(access_token))
    ...
    async def set_device_status_by_address(self, privilege_token, address):
        url = f'/v1/device-config/eth-addr/{address}/status'
        return self.request('PATCH','VehicleSignalDecoding', url, headers=self._get_auth_headers(privilege_token))
